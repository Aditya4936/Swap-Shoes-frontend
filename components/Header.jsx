...
const Header = () => {
  ...
  return (
    ...
    >
      <Wrapper className={"h-[60x] flex items-center justify-between"}>
        <Link href="/">
          <img src="./logo.svg" className="w-[40px] md:w-[40px]" />
        </Link>
        <Menu
       ...
       {mobileMenu && (
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center
            items-center hover:bg-black/[0.05] cursor-pointer relative -mr-2 md:hidden"
          >
            {mobileMenu ? (
              <VscChromeClose
                className="text-[16px]"
